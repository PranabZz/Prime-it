                        ...
                        <li x-data="{ open:false }">
                            <div class="relative flex justify-between text-gray-200 hover:text-white focus-within:text-white" @click="open=!open">
                                <div class="flex items-center w-full">
                                    ...
                                    <a href="#" class="inline-block w-full py-2 pl-8 pr-4 text-sm rounded hover:bg-blue-800 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:bg-blue-800">Testomonial</a>
                                </div>
                                <button class="absolute right-0 flex items-center p-1" tabindex="-1">
                                    <svg class="w-5 h-5 stroke-current" fill="none" viewBox="0 0 24 24">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.25 10.75L12 14.25L8.75 10.75"></path>
                            ...
                            <div class="pt-2 pl-4">
                                <ul class="flex flex-col pl-2 text-gray-200 border-l border-gray-300 space-y-2" x-show="open" x-cloak @click.outside="open = false">
                                    <li>
                                        <a href="{{ route('admin.testimonial.index') }}" class="inline-block w-full px-4 py-2 text-sm rounded hover:bg-blue-800 hover:text-white focus:outline-none focus:ring-1 focus:ring-blue-500 focus:text-white">All
                                            Testimonial
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('admin.testimonial.create') }}" class="inline-block w-full px-4 py-2 text-sm rounded hover:bg-blue-800 hover:text-white focus:outline-none focus:ring-1 focus:ring-blue-500 focus:text-white">Add
                                            Testimonial
                                        </a>
                                    </li>
                                </ul>
                                                ...
                                                <li x-data="{ open:false }">
                                                    <div class="relative flex justify-between text-gray-200 hover:text-white focus-within:text-white" @click="open=!open">
                                                        <div class="flex items-center w-full">
                                                            ...
                                                            <a href="#" class="inline-block w-full py-2 pl-8 pr-4 text-sm rounded hover:bg-blue-800 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:bg-blue-800">Merchandies</a>
                                                        </div>
                                                        <button class="absolute right-0 flex items-center p-1" tabindex="-1">
                                                            <svg class="w-5 h-5 stroke-current" fill="none" viewBox="0 0 24 24">
                                                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.25 10.75L12 14.25L8.75 10.75"></path>
                                                    ...
                                                    <div class="pt-2 pl-4">
                                                        <ul class="flex flex-col pl-2 text-gray-200 border-l border-gray-300 space-y-2" x-show="open" x-cloak @click.outside="open = false">
                                                            <li>
                                                                <a href="{{ route('admin.merchandies.index') }}" class="inline-block w-full px-4 py-2 text-sm rounded hover:bg-blue-800 hover:text-white focus:outline-none focus:ring-1 focus:ring-blue-500 focus:text-white">All
                                                                    Merchandies
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="{{ route('admin.merchandies.create') }}" class="inline-block w-full px-4 py-2 text-sm rounded hover:bg-blue-800 hover:text-white focus:outline-none focus:ring-1 focus:ring-blue-500 focus:text-white">Add
                                                                    Merchandies
                                                                </a>
                                                            </li>
                                                        </ul>
