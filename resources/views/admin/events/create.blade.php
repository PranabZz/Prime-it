                ...
                <div class="flex-1">
                    <div class="w-full p-4 bg-white rounded-lg">
                        <div class="p-4 space-y-6" x-data="{ title:'{{ old('title') }}' }">
                            ...
                            <x-form.group label="Price" for="price_of_event">
                                <x-form.input type="number" id="price_of_event" name="price_of_event" value="{{ old('price_of_event') }}" />
                                <x-form.error name="price_of_event" />
                            </x-form.group>
