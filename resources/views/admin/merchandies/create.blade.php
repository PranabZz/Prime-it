<x-admin.app title="Merchandies | Create">
    <div class="mt-8 space-y-6">
        <h1 class="text-xl font-bold text-gray-900 uppercase">Add new Merchandies</h1>

        <form method="POST" action="{{ route('admin.merchandies.store') }}" enctype="multipart/form-data">
            @csrf
                ...
                <div class="w-full p-4 bg-white rounded-lg">
                    <div class="p-4 space-y-6">
                        ...
                        <x-form.group label="Title" for="title">
                            <x-form.input type="text" id="title" name="title" value="{{ old('name') }}" placeholder="Ram Bhadur"/>
